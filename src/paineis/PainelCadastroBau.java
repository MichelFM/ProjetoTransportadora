...
public class PainelCadastroBau extends JPanel {
	...
	public PainelCadastroBau(List<Veiculos> veiculos) {
		super();
		...
		jbCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (!jtfFabricante.getText().isBlank() && 
					...
					veiculos.add( new Bau(placa, tipoCombustivel, fabricante, numeroChassi, cor, tipoVeiculo, modelo, anoFabricacao, anoModelo, tipoCaminhao, placa));
